...
CEnemy_Knight::CEnemy_Knight(int x, int z, ENEMY_Data enemy_data) :CEnemy(enemy_data.enemy_type), C3DObj(C3DObj::TYPE_ENEMY)
{
...
CEnemy_Knight::~CEnemy_Knight()
{
	AnimeModel_Finalize(&anime_model);
}


void CEnemy_Knight::Initialize(int x, int z, ENEMY_Data enemy_data)
{
	int i;
...
void CEnemy_Knight::EnemySkill(void)
{

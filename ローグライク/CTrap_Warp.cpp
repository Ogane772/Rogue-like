...
CTrapWarp::CTrapWarp(int x, int z, int trap_type) :CTrap(trap_type), C3DObj(C3DObj::TYPE_TRAP)
{
...
void CTrapWarp::Initialize(int x, int z, int trap_type)
{
	alive = true;
	m_Mapz = z;
	m_Mapx = x;
...
void CTrapWarp::Finalize(void)
{

}

void CTrapWarp::Update(void)
{

}

void CTrapWarp::Draw(void)
{
	// ワールド座標変換行列の作成と設定
	D3DXMATRIX mtxWorld;

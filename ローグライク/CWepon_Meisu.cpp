...
CWeponMeisu::CWeponMeisu(int x, int z) :CWepon(TYPE_MEISU), C3DObj(C3DObj::TYPE_WEPON)
{
	Initialize(x, z);
}
...
CWeponMeisu::~CWeponMeisu()
{

}

void CWeponMeisu::Initialize(int x, int z)
{
	alive = true;
	m_Mapz = z;
	m_Mapx = x;
...
void CWeponMeisu::Finalize(void)
{

}

void CWeponMeisu::Update(void)
{

}

void CWeponMeisu::Draw(void)
{
	// ワールド座標変換行列の作成と設定
	D3DXMATRIX mtxWorld;

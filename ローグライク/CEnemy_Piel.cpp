...
CEnemy_Piel::CEnemy_Piel(int x, int z, ENEMY_Data enemy_data) :CEnemy(enemy_data.enemy_type), C3DObj(C3DObj::TYPE_ENEMY)
{
...
CEnemy_Piel::~CEnemy_Piel()
{
	AnimeModel_Finalize(&anime_model);
}


void CEnemy_Piel::Initialize(int x, int z, ENEMY_Data enemy_data)
{
	int i;
	...
	strcpy_s(animefile, C3DObj::Get_AnimeFileName(MODELL_ANIME_PIEL));
...
void CEnemy_Piel::EnemySkill(void)
{

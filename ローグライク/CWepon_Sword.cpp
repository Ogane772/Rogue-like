...
CWeponSword::CWeponSword(int x, int z) :CWepon(TYPE_SWORD), C3DObj(C3DObj::TYPE_WEPON)
{
	Initialize(x, z);
}
...
CWeponSword::~CWeponSword()
{

}

void CWeponSword::Initialize(int x, int z)
{
	alive = true;
	m_Mapz = z;
	m_Mapx = x;
...
void CWeponSword::Finalize(void)
{

}

void CWeponSword::Update(void)
{

}

void CWeponSword::Draw(void)
{
	// ワールド座標変換行列の作成と設定
	D3DXMATRIX mtxWorld;
...
bool CWeponSword::Damage(int str, float angle)
{
	return 0;
}
